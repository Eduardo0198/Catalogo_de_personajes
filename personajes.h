...
public:
    ...
    // Constructor
    Personaje(string name, string house, string animal_, int born_year, string lineage)
        : nombre(name), casa(house), animal(animal_), ano_nacimiento(born_year), linaje(lineage) {}
    ...
    static Personaje crearpersonaje(string name, string house, string animal_, int born_year, string lineage) {
        return Personaje(name, house, animal_, born_year, lineage);
    }
